...
class TopStoriesPresenter(
    ...
    private fun callbackWithAllStoriesInList(topStoriesView: AsyncListView<StoryViewModel>): com.novoda.materialised.hackernews.generics.ValueCallback<List<Long>> {
        return com.novoda.materialised.hackernews.generics.valueCallbackFor {
            if (it.size > 0) {
    ...
    private fun callbackToStoriesViewWithSingleStoryViewModel(topStoriesView: AsyncListView<StoryViewModel>): com.novoda.materialised.hackernews.generics.ValueCallback<Story> {
        return com.novoda.materialised.hackernews.generics.valueCallbackFor {
